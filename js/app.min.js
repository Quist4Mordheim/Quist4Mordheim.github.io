...
function (e, t) {
	...
	e.uiRestrictSpellSelect = function () {
		...
		if (spells.length > 0) {
			...
			e.hide(".panel-spells .ability-select option + option, .panel-spells .ability-select optgroup");
			e.show(`${spellgroup}, ${spellgroup} option:not(${alreadyChosenSpells})`);
		}
	},
	e.uiRestrictSkillSelect = function () {
        ...
        e.hide(`${form} option + option, ${form} optgroup:not(.skill-options-mixed)`);
        e.show(skills.map(expand).join(", "))
