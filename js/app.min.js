...
function (e, t) {
	...
	e.spellViewUpdate = function () {
		...
		try {
			for (var n, l = e.activeProfile.spells[Symbol.iterator](); !(i = (n = l.next()).done); i = !0) {
				...
				s.info.tzeentchs_curse !== t && (P.tzeentchs_curse = s.info.tzeentchs_curse),
	...
	e.mutationViewUpdate = function () {
		$("#mutations-remaining").text(e.activeProfile.mutations.length + " / 3 Mutations"),
		$(".mutation-row").remove();
		var i = !0,
		a = !1,
		r = t;
	...
	e.uiRestrictSpellSelect = function () {
		if (!(e.activeProfile.restrictions.spells.length < 1)) {
			$(".panel-spells .ability-select option").show(),
			$(".panel-spells .ability-select optgroup").hide();
	...
	e.uiRestrictSkillSelect = function () {
		$(".panel-skills .ability-select option").show(),
		$(".panel-skills .ability-select optgroup").hide();
	...
	e.uiOptionShowAll = function () {
		$(".panel-ability .ability-select optgroup").show(),
		$(".panel-ability .ability-select option").show()
	},
